...
// Consulta acima pode ser substituida pelo comando abaixo

//Page<Produto> findDistinctByNomeContainingCategoriasIn(String nome, list <Categoria> categorias, Pageable pageRequest);